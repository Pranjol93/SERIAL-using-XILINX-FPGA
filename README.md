# Design and Implementation of a Serial IP Core and Linux Device Drivers
...
gpio_system_top.sv is the top module of the UART that conects to blackboard, serial_v1_0.v is the wrapper, serial_v1_0_AXI.v is the systme verilog implementation of the UART
